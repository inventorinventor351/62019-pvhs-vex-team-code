...
Motor rightChassis3(6, MOTOR_GEARSET_18, 1, MOTOR_ENCODER_DEGREES); //Port 6, 200 RPM, reversed, degrees for encoder units
Motor rightChassis3(7, MOTOR_GEARSET_36, 0, MOTOR_ENCODER_DEGREES); //Port 7, 100 RPM, not reversed, degrees for encoder units
Motor rightChassis3(8, MOTOR_GEARSET_18, 0, MOTOR_ENCODER_DEGREES); //Port 8, 200 RPM, not reversed, degrees for encoder units