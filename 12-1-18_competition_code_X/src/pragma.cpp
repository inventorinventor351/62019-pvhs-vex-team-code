...
Motor shooter(5, MOTOR_GEARSET_6, 0, E_MOTOR_ENCODER_ROTATIONS); //Port 5, 100 RPM gearset, not reversed, units of rotations for encoder
Motor intake(6, MOTOR_GEARSET_36, 0, E_MOTOR_ENCODER_ROTATIONS); //Port 6, 600 RPM gearset, not reversed, units of rotations for encoder
