...
Motor leftChassis1(1, MOTOR_GEARSET_18, 0, E_MOTOR_ENCODER_ROTATIONS); //Port 1, 200 RPM gearset, not reversed, units of rotations for encoder
...
Motor rightChassis1(3, MOTOR_GEARSET_18, 1, E_MOTOR_ENCODER_ROTATIONS); //Port 3, 200 RPM gearset, reversed, units of rotations for encoder
