...
Motor leftBase3 (8, MOTOR_GEARSET_18, 0); //normal motor plugged into port 8 and not reversed and only X team
Motor rightBase3 (9, MOTOR_GEARSET_18, 0); //normal motor plugged into port 9 and not reversed and only X team