...
Motor rightBase2 (4, MOTOR_GEARSET_18, 0); //normal motor plugged into port 4 and not reversed
...
Motor rightBase3 (9, MOTOR_GEARSET_18, 0); //normal motor plugged into port 9 and not reversed and only X team has it
...
ADIDigitalOut descorer (6); //pistons y-cabled and plugged into legacy port 6 and only P team has it
ADIDigitalOut transPstn (7); //piston plugged into port 7 and only P team has it